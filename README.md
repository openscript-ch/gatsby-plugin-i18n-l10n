...
![Codecov](https://img.shields.io/codecov/c/github/openscript-ch/gatsby-plugin-i18n-l10n) ![GitHub Workflow Status](https://img.shields.io/github/workflow/status/openscript-ch/gatsby-plugin-i18n-l10n/Continuous%20integration) ![npm](https://img.shields.io/npm/v/gatsby-plugin-i18n-l10n) ![npm](https://img.shields.io/npm/dm/gatsby-plugin-i18n-l10n) 
