...
type GatsbyNodeOnPostBootstrap = NonNullable<GatsbyNode['onPostBootstrap']>;
...
export type OnPostBootstrap = (
  args: Parameters<GatsbyNodeOnPostBootstrap>[0],
  options?: PluginOptions,
) => ReturnType<GatsbyNodeOnPostBootstrap>;
